...
\begin{document}
    ...
    Меню для перехода между экранами расположено в нижней части экрана.
    ...
    \subsubsection{Описание алгоритма и функционирования сервера}
    ...
    \subsubsection{Описание и обоснование метода организации входных и выходных данных сервера}
    ...
    \addition{Терминология}

    \noindent\textbf{Сервер} — выделенный или специализированный компьютер для выполнения сервисного программного обеспечения.\\\\
    \textbf{Серверное приложение} — программа на сервере.\\\\
    \textbf{Деплой} — удалённый запуск серверного приложения.\\\\
    \textbf{Heroku} — сервис для деплоя.\\\\
    ...
    \addition{Структура облачного хранилища}
    ...
    \addition{Описание классов, структур, методов, полей сервера}

    \begin{table}[ht]
        \caption{\label{tab:classes-table-server}Функциональное назначение классов сервера.}
        \centering
    ...
    \addition{Описание классов, структур, методов, полей мобильного приложения}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3.8cm}|p{3cm}|p{3cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{p{6.5cm}|}{\textbf{Описание}} \\ \hline
            Items & public & ObservableCollection <Problem> & \multicolumn{2}{p{6.5cm}|}{Коллекция с обращениями} \\ \hline
            LoadItems Command & public & Command & \multicolumn{2}{p{6.5cm}|}{Хранит действие, которое воспроизводится при свайпе вверх} \\ \hline
            \multicolumn{5}{|l|}{\textbf{Методы}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \textbf{Аргументы} & \textbf{Назначение} \\ \hline
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3.8cm}|p{3cm}|p{3cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{p{6.5cm}|}{\textbf{Описание}} \\ \hline
            Item & public & Problem & \multicolumn{2}{p{6.5cm}|}{Содержит информацию о проблеме} \\ \hline
            RefreshCommand Command & public & Command & \multicolumn{2}{p{6.5cm}|}{Хранит действие, которое воспроизводится при свайпе вверх} \\ \hline
            \multicolumn{5}{|l|}{\textbf{Методы}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \textbf{Аргументы} & \textbf{Назначение} \\ \hline
            ItemsViewModel & public & void & - & Конструктор \\ \hline
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3.8cm}|p{3cm}|p{3cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{p{6.5cm}|}{\textbf{Описание}} \\ \hline
            OpenWeb Command & public & ICommand & \multicolumn{2}{p{6.5cm}|}{Содержит команду для открытия веб-страницы ВШЭ} \\ \hline
            \multicolumn{5}{|l|}{\textbf{Методы}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \textbf{Аргументы} & \textbf{Назначение} \\ \hline
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3cm}|p{3cm}|p{3cm}|p{2.6cm}|p{4cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{l|}{\textbf{Описание}} \\ \hline
            Id & public & int & \multicolumn{2}{l|}{ID обращения} \\ \hline
            Author & public & string & \multicolumn{2}{l|}{Автор обращения} \\ \hline
            Title & public & string & \multicolumn{2}{l|}{Заголовок обращения} \\ \hline
            Description & public & string & \multicolumn{2}{p{7cm}|}{Подробное описание обращения} \\ \hline
            Status & public & string & \multicolumn{2}{p{7cm}|}{Статус обращения} \\ \hline
            CreatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата создания обращения} \\ \hline
            UpdatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата обновления обращения} \\ \hline
            Messages & public & List<Message> & \multicolumn{2}{p{7cm}|}{Сообщения обращения} \\ \hline
            \multicolumn{5}{|l|}{\textbf{Методы}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \textbf{Аргументы} & \textbf{Назначение} \\ \hline
            GetDictionary Params & public & Dictionary <string, object> & - & Возвращает словарь с параметрами для POST-запросов \\ \hline
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3cm}|p{2.6cm}|p{4cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{l|}{\textbf{Описание}} \\ \hline
            Id & public & int & \multicolumn{2}{l|}{ID сообщения} \\ \hline
            Author & public & int & \multicolumn{2}{l|}{ID автора сообщения} \\ \hline
            AuthorFirstName & public & string & \multicolumn{2}{l|}{Имя автора сообщения} \\ \hline
            AuthorFirstName & public & string & \multicolumn{2}{l|}{Фамилия автора сообщения} \\ \hline
            Text & public & string & \multicolumn{2}{l|}{Текст сообщения} \\ \hline
            CreatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата создания сообщения} \\ \hline
            UpdatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата обновления сообщения} \\ \hline
            \multicolumn{5}{|l|}{\textbf{Методы}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \textbf{Аргументы} & \textbf{Назначение} \\ \hline
            GetDictionary Params & public & Dictionary <string, object> & - & Возвращает словарь с параметрами для POST-запросов \\ \hline
        \end{tabular}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3cm}|p{2.6cm}|p{4cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{l|}{\textbf{Описание}} \\ \hline
            Id & public & int & \multicolumn{2}{l|}{ID новости} \\ \hline
            Title & public & string & \multicolumn{2}{l|}{Заголовок новости} \\ \hline
            Description & public & string & \multicolumn{2}{l|}{Описание новости} \\ \hline
            IsImportant & public & string & \multicolumn{2}{l|}{Важная ли новость} \\ \hline
            CreatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата создания новости} \\ \hline
            UpdatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата обновления новости} \\ \hline
            \multicolumn{5}{|l|}{\textbf{Методы}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \textbf{Аргументы} & \textbf{Назначение} \\ \hline
            GetDictionary Params & public & Dictionary <string, object> & - & Возвращает словарь с параметрами для POST-запросов \\ \hline
            CreatedAtBeauty & public & string & - & Возвращает красивую строку с датой \\ \hline
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3cm}|p{2.6cm}|p{4cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{l|}{\textbf{Описание}} \\ \hline
            Id & public & int & \multicolumn{2}{l|}{ID профиля} \\ \hline
            FirstName & public & string & \multicolumn{2}{l|}{Имя} \\ \hline
            LastName & public & string & \multicolumn{2}{l|}{Фамилия} \\ \hline
            Info & public & string & \multicolumn{2}{l|}{Дополнительная нформация о профиле} \\ \hline
            Role & public & string & \multicolumn{2}{l|}{Роль: студент или агент поддержки} \\ \hline
            Room & public & string & \multicolumn{2}{l|}{Комната} \\ \hline
            Dormitory & public & Dormitory & \multicolumn{2}{l|}{Общежитие} \\ \hline
        \end{tabular}
    \end{table}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3cm}|p{2.6cm}|p{4cm}|}
            ...
            \multicolumn{5}{|l|}{\textbf{Свойства}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \multicolumn{2}{l|}{\textbf{Описание}} \\ \hline
            Question & public & string & \multicolumn{2}{l|}{Вопрос} \\ \hline
            Answer & public & string & \multicolumn{2}{l|}{Ответ} \\ \hline
        \end{tabular}
    \end{table}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{|p{3.2cm}|p{3cm}|p{3cm}|p{2.6cm}|p{4cm}|}
            ...
            Title & public & string & \multicolumn{2}{l|}{Заголовок новости} \\ \hline
            Description & public & string & \multicolumn{2}{l|}{Описание новости} \\ \hline
            TargetDate & public & string & \multicolumn{2}{l|}{Важная ли новость} \\ \hline
            CreatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата создания новости} \\ \hline
            UpdatedAt & public & string & \multicolumn{2}{p{7cm}|}{Дата обновления новости} \\ \hline
            \multicolumn{5}{|l|}{\textbf{Методы}} \\ \hline
            \textbf{Имя} & \textbf{Модификатор доступа} & \textbf{Тип} & \textbf{Аргументы} & \textbf{Назначение} \\ \hline
